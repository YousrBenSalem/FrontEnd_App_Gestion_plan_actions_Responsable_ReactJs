...
function SideBar() {
  ...
  <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
        <div className="app-brand demo">
          <Link to="/" className="app-brand-link">
            ...
            <span className="app-brand-text demo menu-text fw-bolder ms-2">PlanifyGov</span>
          </Link>
        ...
        <ul className="menu-inner py-1 ">
          ...
          <li className={`menu-item ${location.pathname === '/' ? 'active' : ''}`}>
            ...
            <span className="menu-header-text">Pages des secteurs</span>
          </li>
        

                    {/* Secteur */}
    
          <li className={`menu-item ${location.pathname === '/addSecteur' ? 'active' : ''}`}>
            <Link to="/addSecteur"className="menu-link" >
            <i className="menu-icon tf-icons bx bx-folder-plus" /> {/* Nouvelle icône */}
              <div data-i18n="Secteur">Ajouter un secteur</div>
            </Link>
          </li>
            <li className={`menu-item ${location.pathname === '/secteurs' ? 'active' : ''}`}>
              <Link to="/secteurs" className="menu-link">
                <i className="menu-icon tf-icons bx bx-buildings" /> {/* Nouvelle icône */}
                <div data-i18n="Secteurs">Secteurs</div>
              </Link>
            </li>

        
      {/*     <li className="menu-header small text-uppercase">
            <span className="menu-header-text">Pages des Plans d'actions</span>
          </li> */}
              ...
              <li className="menu-header small text-uppercase">
            <span className="menu-header-text">Pages de participant</span>
          </li>

            {/* Participants */}
                      <li className={`menu-item ${location.pathname === '/addParticipant' ? 'active' : ''}`}>
              <Link to="/addParticipant" className="menu-link">
                <i className="menu-icon tf-icons bx bx-user-plus" /> {/* Change l'icône ici */}
                <div data-i18n="Participant">Ajouter un participant</div>
              </Link>
            </li>
            <li  className={`menu-item ${location.pathname === '/participant' ? 'active' : ''}`}>
              <Link to="/participant" className="menu-link">
                <i className="menu-icon tf-icons bx bx-group" /> {/* Change l'icône ici */}
  ...
  <li className="menu-header small text-uppercase">
            ...
            <li  className={`menu-item ${location.pathname === '/calendrier' ? 'active' : ''}`}>
              <Link to="/calendrier" className="menu-link">
                <i className="menu-icon tf-icons bx  bx-calendar" /> {/* Change l'icône ici */}
                <div data-i18n="Participants">Calendrier</div>
              </Link>
            </li>
