...
useEffect(() => {
    ...
    const handleFormSubmit = async (e, entity) => {
        ...
        try {
            switch (entity) {
                case "secteur":
                    res = await secteur.createSecteur(formData);
                    if (res) {
                        toast.success("Secteur ajouté avec succès !");
                      setSecteurId(res.data.data._id)};
                    break;
                case "structure":
                ...
                return (
                    <form className='row'>
                        <div className="mb-3 col-md-6">
                            ...
                            <input className="form-control" type="text" name="libelle" onChange={handleChange} value={formData.libelle || ""}
 required />
                        </div>
                        <div className="mb-3 col-md-6">
                            <label className="form-label">Code</label>
                            <input className="form-control" type="text" name="code" onChange={handleChange}                     value={formData.code || ""}
 required />
                        </div>
                        <div className="mt-4 d-flex justify-content-end">
                            <button type="submit" className="btn btn-primary me-2" onClick={(e) => handleFormSubmit(e, "secteur")}>{step < 6 ? 'Suivant' : 'Terminer'}</button>
                        </div>
                    </form>
                );
            case 2:
          ...
          <ToastContainer />
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Ajouter un secteur</li>
                </ol>
            </nav>
            <div className="row">
                            ...
                            <div className="col">
                                <div className="timeline-steps aos-init aos-animate" data-aos="fade-up">
                                    <div className="timeline-steps mb-0">
                                        {["Ajouter secteur", "Ajouter structure", "Ajouter plan", "Ajouter activité", "Ajouter sous activité", "Ajouter tâche"].map((label, index) => (
