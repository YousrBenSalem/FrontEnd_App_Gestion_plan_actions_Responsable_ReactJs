...
const handleNextStep = (e) => {
        ...
        if (step < 1) setStep(step + 1); // Passe à l'étape suivante
    };
        ...
        <div className="container-xxl flex-grow-1 container-p-y">
            ...
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link to={`/`}>Tache</Link></li>

                    <li className="breadcrumb-item active" aria-current="page">Ajouter une tache</li>
                </ol>
            </nav>
            <div className="row">
