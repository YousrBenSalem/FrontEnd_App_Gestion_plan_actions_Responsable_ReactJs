...
const handleNextStep = (e) => {
        ...
        if (step < 3) setStep(step + 1); // Passe à l'étape suivante
    };
        ...
        <div className="container-xxl flex-grow-1 container-p-y">
            ...
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link to={`/`}>Activites</Link></li>

                    <li className="breadcrumb-item active" aria-current="page">Ajouter une activite</li>
                </ol>
            </nav>
            <div className="row">
                            ...
                            <div className="col">
                                <div className="timeline-steps aos-init aos-animate" data-aos="fade-up">
                                    <div className="timeline-steps mb-0">
                                        {[  
                                      "Ajouter activité", "Ajouter sous activité", "Ajouter tâche"].map((label, index) => (
