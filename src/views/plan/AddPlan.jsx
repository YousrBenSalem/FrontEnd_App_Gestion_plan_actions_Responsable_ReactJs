...
function AddPlan() {
    ...
    const [sousActiviteId, setSousActiviteId] = useState(null);
      ...
      console.log("structure Id params", structureId)
...
useEffect(() => {
    ...
    const handleNextStep = (e) => {
        ...
        if (step < 4) setStep(step + 1); // Passe à l'étape suivante
    };
          ...
          <ToastContainer />
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Ajouter un plan</li>
                </ol>
            </nav>
            <div className="row">
