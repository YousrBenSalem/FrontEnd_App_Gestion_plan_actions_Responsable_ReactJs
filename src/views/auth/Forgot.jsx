    ...
    <div className="authentication-inner py-4">
      ...
      <div className="card">
        <div className="card-body">
          ...
          <form onSubmit={Forgot} id="formAuthentication" className="mb-3" >
            <div className="mb-3">
              <label htmlFor="email" className="form-label">Email</label>
              <input type="text" className="form-control" id="email" name="email" placeholder="Enter your email"   onChange={OnchangeHandler} />
            </div>
