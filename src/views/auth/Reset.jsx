        ...
        <div className="card-body">
          ...
          <div className="app-brand justify-content-center">
            <Link to="/" className="app-brand-link gap-2">
              ...
              <span className="app-brand-text demo text-body fw-bolder">PlanifyGov</span>
            </Link>
          </div>
          {/* /Logo */}
          <h4 className="mb-2">Reset Password? 🔒</h4>
          <p className="mb-4">Enter your new password</p>
          <form id="formAuthentication" className="mb-3" onSubmit={Reset}>
            <div className="mb-3">
              <label htmlFor="password" className="form-label">Password</label>
              <input type="password" className="form-control" id="password" name="password" placeholder="Enter your new password" onChange={(e)=>setPassword(e.target.value)} />
              
            </div>
              <div className="mb-3">
              <label htmlFor="password" className="form-label"> Confirm Password</label>
              <input type="password" className="form-control" id="password" name="password" placeholder="Enter your new password"  onChange={(e)=>{setConfirmPass(e.target.value)}} />
