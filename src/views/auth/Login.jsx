...
function Login() {
  ...
  const SignIn = async (event) => {
    ...
    try {
      ...
      const itemType = user?.itemType?.trim().toLowerCase();
      ...
      if (itemType === "responsable" && UserVerify === true) {
        ...
        <div className="authentication-inner">
          ...
          <div className="card">
            <div className="card-body">
              ...
              {/* /Logo */}
              <h4 className="mb-2">Welcome to PlanifyGov! 👋</h4>
              <p className="mb-4">
                Please sign-in to your account and start the adventure
              </p>
              <form id="formAuthentication" className="mb-3" onSubmit={SignIn}>
                <div className="mb-3">
